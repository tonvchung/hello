...
background-image: https://tonv.cc/style/images/gitignore.png
...
*.a       # 忽略所有 .a 结尾的文件
!lib.a    # 但 lib.a 除外
/-tonvccsite     # 仅仅忽略项目根目录下的 tonvccsite 文件，不包括 subdir/tonvccsite
tonvcc/    # 忽略 tonvcc文件夹/ 目录下的所有文件以及文件夹本身
